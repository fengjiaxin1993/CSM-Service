...
│          │                       V1                           │                              V2                                    │
├──────────┼────────────────────────────────────────────────────┼───────────────────────────────────────────────────────────────────┤
│ PDF解析  │ with pymupdf.open() 简单打开                       │ try/finally 管理 doc 生命周期，记录倾斜文字作为水印               │
│ 水印处理 │ 无                                                 │ 提取 water_text_set，在表格数据中调用 remove_water() 去水印       │
│ 表格提取 │ 无                                                 │ _extract_risk_table()：定位"风险描述"到"影响范围"之间的表格       │
│          │                                                    │   - _get_keyword_bbox() 定位关键词坐标                           │
│          │                                                    │   - find_tables() 查找表格                                       │
│          │                                                    │   - _merge_cross_page_tables() 合并跨页表格                      │
│          │                                                    │   - convert_table() 将表格转为字典列表                           │
│ 输出结构 │ 扁平结构                                           │ 嵌套结构（以 risk_table 为核心）                                  │
│          │ {                                                  │ {                                                                │
│          │   "name": "xxx",                                   │   "name": "xxx",                                                 │
│          │   "code": "xxx",                                   │   "code": "xxx",                                                 │
│          │   "level": 1,                                      │   "level": 1,                                                    │
│          │   "desc": "xxx",      ← 顶层字段                   │   "influence": "xxx",                                            │
│          │   "influence": "xxx",                               │   "risk_table": [{              ← 表格数据聚合                   │
│          │   "check": "xxx",                                   │     "name": "xxx",                                              │
│          │   "repair": "xxx",                                  │     "code": "xxx",                                              │
│          │   "requirement": "xxx",                             │     "desc": "xxx",                                              │
│          │   "cve_code": "xxx"                                 │     "influence": "xxx",                                         │
│          │ }                                                  │     "check": "xxx",                                             │
│          │                                                    │     "repair": "xxx",                                             │
│          │                                                    │     "requirement": "xxx"                                        │
│          │                                                    │   }]                                                             │
│          │                                                    │ }                                                                │
│ 适用场景 │ 简单预警单，无表格内容                              │ 含漏洞表格的复杂预警单，需要提取每个漏洞的详细信息                 │
└──────────┴────────────────────────────────────────────────────┴───────────────────────────────────────────────────────────────────┘
"""
